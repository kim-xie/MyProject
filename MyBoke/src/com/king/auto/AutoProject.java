...
public class AutoProject {
	...
	private static String beanPath = "com/king/bean/";
	private static String daoPath = "com/king/dao/";
	private static String servicePath = "com/king/service/";
	private static String serviceImplPath = "com/king/service/"+smallBeanName+"/impl/";
	private static String webPath = "com/king/web/"+smallBeanName+"/";
	...
	//包名
	private static String beanPackage ="com.king.bean";
	private static String daoPackage ="com.king.dao";
	private static String servicePackage ="com.king.service";
	private static String serviceImplPackage ="com.king.service"+smallBeanName+".impl";
	private static String webPackage ="com.king.web";
	...
	public static void createTable(){
		try {
			...
			Connection connection = DriverManager.getConnection("jdbc:mysql://localhost:3306/myBoke?useUnicode=true&characterEncoding=utf8&zeroDateTimeBehavior=convertToNull", "root", "xiaoer");
