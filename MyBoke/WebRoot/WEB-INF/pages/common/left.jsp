...
<style>
	/* left nav  start*/
	.left-nav,.tool-nav{position:fixed;top:0;left:-240px;background:#2b2d2e;width:240px;height:100%;padding-top:60px;z-index:3;}
	.nav_title{color:rgb(255,255,255);margin-bottom:20px;padding:0 30px;}
	.parents{width:100%;height:100%;}
	.parents .p_title{border-bottom:1px solid #333;height:40px;line-height:40px;padding:5px 30px;}
	...
	.parents .tool_title{border-bottom:1px solid #333;height:40px;line-height:40px;padding:5px 30px;font-size:18px;}
	.parents .tool_title a{color:rgb(182,179,173);font-size:20px;font-weight:600;}
	...
	.project_button{top:195px;background-color:#2DD888;width:50px;height:50px;padding:17px;border-radius:50%;cursor:pointer;position:fixed;left:10px;z-index:100;-webkit-transform:translateX(0);-ms-transform:translateX(0);transform:translateX(0);-webkit-transition:-webkit-transform .5s;transition:transform .5s;}
