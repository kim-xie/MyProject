...
<body>
	...
	<div class="divBody">
		<div class="divTitle">
			<span class="spanTitle">King博客平台</span>
		</div>
		<div class="divContent">
			<div style="margin: 20px;">
				<img src="${basePath}/resources/imgs/msg/duihao.jpg" width="150" style="float:left; margin-right:30px;"/> 
				<span style="font-size:30px;color:#c30;font-weight:900;">恭喜您注册成功，请马上到邮箱激活！</span>
				<br/> <br/> <br/> <br/> 
				<span style="margin-left:50px;">
					<a target="_top" href="<c:url value='/user/toLogin.do'/>">登录</a>
				</span> 
				<span style="margin-left: 50px;">
					<a target="_top" href="<c:url value='/index.do'/>">主页</a>
				</span>
			</div>
		</div>
	</div>
